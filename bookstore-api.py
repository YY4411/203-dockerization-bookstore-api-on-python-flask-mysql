...
app.config['MYSQL_DATABASE_USER'] = 'Furkan'
app.config['MYSQL_DATABASE_PASSWORD'] = 'Furkan_1'
...
# Write a function named `home` which returns 'Welcome to the Furkan's Bookstore API Service',
# and assign to the static route of ('/')
@app.route('/')
def home():
    return "Welcome to Furkan's Bookstore API Service"
